			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					...
					<option value="">Pilih Program Studi</option>
						...
						<option value="Pendidikan Bahasa Bali" <?php if($data['Program_Studi'] == 'Pendidikan Bahasa Bali'){ echo 'selected'; } ?>>Pendidikan Bahasa Bali</option>
						<option value="Pertambangan" <?php if($data['Program_Studi'] == 'Pertambangan'){ echo 'selected'; } ?>>Pertambangan</option>
						...
						<option value="Keprawatan" <?php if($data['Program_Studi'] == 'Keprawatan'){ echo 'selected'; } ?>>Keprawatan</option>
